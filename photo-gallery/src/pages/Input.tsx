          ...
          <IonContent>
            ...
            <IonList>
              ...
              <IonItem>
                ...
                <IonInput value={cases} onIonChange={e => setCases(e.detail.value!)}required></IonInput>
              </IonItem>
              <IonItem>
                <IonLabel>Deaths</IonLabel>
                <IonInput type="number" value={deaths} onIonChange={e => setDeaths(e.detail.value!)}required></IonInput>
              </IonItem>
              <IonItem>
                <IonLabel>Recovered</IonLabel>
                <IonInput value={recovered} onIonChange={e => setRecovered(e.detail.value!)}required></IonInput>
              </IonItem>
              <IonItem>
